...
namespace 
{
    ...
    bool tolerant_compare(double a, double b) 
    {
    ...
    bool check_interval_overlap(double a_min, double a_max, double b_min, double b_max) 
    {
    ...
    bool pointInTriangle2D(double x, double y,
    ...
    bool segmentsIntersect2D(double x1, double y1, double x2, double y2,
    ...
    bool coplanarSegmentTriangleIntersection(const Point3D& p1, const Point3D& p2,
                                            const Point3D& a, const Point3D& b, const Point3D& c) 
    {
        Point3D normal = crossProduct(b - a, c - a);
        
        int maxIndex = 0;
        double maxVal = std::fabs(normal.x);
    ...
    bool pointInTriangle(const Point3D& p, const Point3D& a, const Point3D& b, const Point3D& c) 
    {
        Point3D v0 = b - a;
        Point3D v1 = c - a;
        Point3D v2 = p - a;
    ...
    bool pointOnTriangleEdge(const Point3D& p, const Point3D& a, const Point3D& b, const Point3D& c) 
    {
    ...
    bool segmentTriangleIntersection(const Point3D& p1, const Point3D& p2,
                                   const Point3D& a, const Point3D& b, const Point3D& c) 
    {
        Point3D ab = b - a;
        Point3D ac = c - a;
    ...
    bool isTriangleDegenerate(const Point3D& a, const Point3D& b, const Point3D& c) 
    {
    ...
    bool checkPlaneSeparation(const Point3D& a1, const Point3D& b1, const Point3D& c1,
    ...
    bool checkAxisSeparation(const Point3D& a1, const Point3D& b1, const Point3D& c1,
    ...
    bool checkEdgeAxisSeparation(const Point3D& a1, const Point3D& b1, const Point3D& c1,
                                const Point3D& a2, const Point3D& b2, const Point3D& c2) 
    {
    ...
    bool coplanarTrianglesIntersect(const Point3D& a1, const Point3D& b1, const Point3D& c1,
                                  const Point3D& a2, const Point3D& b2, const Point3D& c2) 
    {
